...
# 通知類別
class EzpayAllowanceNotifyType():
    # 簡訊通知
    ...
    *產生檢查碼
    ...
    def generate(arParameters=dict, HashKey='', HashIV='', encType=0):
        ...
        if arParameters:
            ...
            # 取代為與 dotNet 相符的字元
            sMacValue = Ezpay_CheckMacValue.do_str_replace(sMacValue)

            # 編碼
            if encType == Ezpay_EncryptType.ENC_SHA256:

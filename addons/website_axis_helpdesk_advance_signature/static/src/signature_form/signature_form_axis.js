...
class SignatureForm extends Component {
    ...
    onMounted(() => {
        console.log("signature instance:", this.signature);
        console.log("resetSignature method exists:", typeof this.signature.resetSignature === 'function');
        this.rootRef.el.closest('.modal').addEventListener('shown.bs.modal', () => {
            if (this.signature && typeof this.signature.resetSignature === 'function') {
                this.signature.resetSignature();
            } else {
                console.error("resetSignature method not found");
            }
        });
    });
    }
